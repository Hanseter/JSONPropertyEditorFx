...
"oneOf":[
    ...
    {"type":"number"}
        ...
        val control = item.value.control as ComboBox<Schema>
...
"oneOf":[
    ...
    {"type":"number"}
        ...
        val stringControl = stringItem.value.control as TextField
...
"oneOf":[
    ...
    {"type":"number"}
        ...
        val spinner = item.children.single().value.control as Spinner<Number>
        spinner.increment(1)
